                                           ...
                                           tabsetPanel(id="prjtabs",
                                             tabPanel(HTML('<h4 style="color: #005BBB; ">Description</h4>'), value="description", br(),
                                                      ...
                                                      fluidRow(column(3, align="left",
                                                               ...
                                                               column(3, align = "left",
                                                                  textAreaInput("sitecontext", "CONTEXTE", height='400px', placeholder = "Décrire le contexte du site ici...")),
                                                               column(3, align = "left",
                                                                  textAreaInput("descqual", "DESCRIPTION QUALITATIVE", height='170px', placeholder = "Nature, emprise, effets indirects..."), br(),
                                                                  textAreaInput("tempo", "TEMPORALITE", height='170px', placeholder = "Plusieurs phases? Court/long terme...")),
                                                               column(3, align = "left",

                                       ...
                                       conditionalPanel(condition = "input.selectsiteimpact != '0'",
                                         tabsetPanel(id="descrimpact",
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Entrée des données</h4>'), value="impactindata", br(),
                                                              ...
                                                              fluidRow(column(6, align="right", actionButton("addlisthab", "AJOUTER")), column(6, align="left", actionButton("dellisthab", "SUPPRIMER"))), br(),
                                                              ...
                                                              fluidRow(column(6, align="right", actionButton("addlistesp", "AJOUTER")), column(6, align="left", actionButton("dellistesp", "SUPPRIMER"))), br(),
                                                              ...
                                                              fluidRow(column(6, align="right", actionButton("addlistper", "AJOUTER")), column(6, align="left", actionButton("dellistper", "SUPPRIMER"))), br(),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="impactindicng", br(),
                                                              ...
                                                              fluidRow(column(2, align="left", textAreaInput("SIjustifCT", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation faite")),
                                                                       ...
                                                                       column(2, align="left", textAreaInput("SIjustifLT", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation faite")),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Habitat</h4>'), value="impactindicnh", br(),
                                                              ...
                                                              fluidRow(column(6, align="center", HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')), column(6, align="center", HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))), br(),
                                                              fluidRow(column(2, align="left", textAreaInput("SIjustifCTNH", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation court terme")),
                                                                       ...
                                                                       column(2, align="left", textAreaInput("SIjustifLTNH", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation long terme")),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Espèce</h4>'), value="impactindicnsp", br(),
                                                              ...
                                                              fluidRow(column(6, align="center", HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')), column(6, align="center", HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))), br(),
                                                              fluidRow(column(2, align="left", textAreaInput("SIjustifCTNSP", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation court terme")),
                                                                       ...
                                                                       column(2, align="left", textAreaInput("SIjustifLTNSP", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation long terme")),
                                      ...
                                      conditionalPanel(condition = "input.selectsitecompens != '0'",
                                                       tabsetPanel(id="descrcompens",
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Entrée des données</h4>'), value="compensindata", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="right", actionButton("addlisthab2", "AJOUTER")), column(6, align="left", actionButton("dellisthab2", "SUPPRIMER"))), br(),
                                                                            ...
                                                                            fluidRow(column(6, align="right", actionButton("addlistesp2", "AJOUTER")), column(6, align="left", actionButton("dellistesp2", "SUPPRIMER"))), br(),
                                                                            ...
                                                                            fluidRow(column(6, align="right", actionButton("addlistper2", "AJOUTER")), column(6, align="left", actionButton("dellistper2", "SUPPRIMER"))), br(),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="compensindicng", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="center", HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')), column(6, align="center", HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))), br(),
                                                                            fluidRow(column(2, align="left", textAreaInput("SCjustifCT", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation faite")),
                                                                                     ...
                                                                                     column(2, align="left", textAreaInput("SCjustifLT", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation faite")),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Habitat</h4>'), value="compensindicnh", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="center", HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')), column(6, align="center", HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))), br(),
                                                                            fluidRow(column(2, align="left", textAreaInput("SCjustifCTNH", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation court terme")),
                                                                                     ...
                                                                                     column(2, align="left", textAreaInput("SCjustifLTNH", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation long terme")),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Espèce</h4>'), value="compensindicnsp", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="center", HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')), column(6, align="center", HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))), br(),
                                                                            fluidRow(column(2, align="left", textAreaInput("SCjustifCTNSP", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation court terme")),
                                                                                     ...
                                                                                     column(2, align="left", textAreaInput("SCjustifLTNSP", "Justification de l'estimation", height='125px', placeholder = "justification de l'estimation long terme")),

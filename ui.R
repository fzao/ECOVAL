...
shinyUI(fluidPage(title="ECOVAL",
                  ...
                  tabsetPanel(id="tabs",
                              ...
                              tabPanel(value="accueil", HTML('<h4 style="color: #005BBB; "><b>Accueil</b></h4>'),
                                       includeMarkdown("md/accueil_1.md"), br(),
                                       img(src='Image1.png', align = "center"), br(),
                                       ...
                                       img(src='Image2.png', align = "center"), hr(),
                                       includeMarkdown("md/accueil_3.md"), br(),
                                       img(src='Image3.png', width=1000, align = "center"), br(),
                                       includeMarkdown("md/accueil_4.md"), br(),
                                       img(src='Image4.png', align = "center")),
                              # PROJET ----------------------------------------------------

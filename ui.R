                                       ...
                                       tabsetPanel(id="descrcalculs",
                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Pertes</h4>'), br(),
                                                            ...
                                                            tabsetPanel(id="resultpertes", 
                                                                       tabPanel(value="graphe"," Graphe", fluidRow(column(12, align="center", br(), plotOutput('plot_pertes', height = '600px', width = '700px')))),
                                                   ...
                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Gains</h4>'), br(),
                                                            ...
                                                            tabsetPanel(id="resultgains", 
                                                                        tabPanel(value="graphe", "Graphe", fluidRow(column(12, align="center", br(), plotOutput('plot_gains')))),

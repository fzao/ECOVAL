                                           ...
                                           tabsetPanel(id="prjtabs",
                                             tabPanel(HTML('<h4 style="color: #005BBB; ">Description</h4>'), value="description", br(),
                                                      ...
                                                      fluidRow(column(3, align="left",
                                                               ...
                                                               column(6, align = "left",
                                                                  textAreaInput("sitecontext", "CONTEXTE", width='450px', height='105px', placeholder = "Décrire le contexte du site ici..."),
                                                                  textAreaInput("descqual", "DESCRIPTION QUALITATIVE", width='450px', height='105px', placeholder = "Nature, emprise, effets indirects..."),
                                                                  textAreaInput("tempo", "TEMPORALITE", width='450px', height='105px', placeholder = "Plusieurs phases? Court/long terme...")),
                                                               column(3, align = "left",

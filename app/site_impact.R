...
updateTabB <- function(){
  ...
  if(n1 > 0 & n2 > 0 & n3 > 0){
    tableau$B[1,4] <- as.character(round(val1,1))
    tableau$B[2,4] <- as.character(round(val2,1))
    tableau$B[3,4] <- as.character(round(val3,1))
    tableau$B[4,4] <- as.character(round(val4,1))
    tableau$B[5,4] <- as.character(round(val5,1))
    tableau$B[6,4] <- as.character(round(val6,1))
    tableau$B[7,4] <- as.character(round(val7,1))
    tableau$B[8,4] <- as.character(round(val8,1))
    tableau$B[9,4] <- as.character(round(val9,1))
    tableau$B[10,4] <- as.character(round(val10,1))
    tableau$B[11,4] <- as.character(round(val11,1))
    tableau$B[12,4] <- as.character(round(val12,1))
    tableau$B[25,4] <- as.character(round(val25 * 100. / valsurf1,1))
    tableau$B[26,4] <- as.character(round(val26 * 100. / valsurf1,1))
    tableau$B[40,4] <- as.character(round(val40num * 100. / val40den,1))
    tableau$B[41,4] <- as.character(round(val41num * 100. / val41den,1))
    tableau$B[42,4] <- as.character(round(val42num * 100. / val42den,1))
    tableau$B[14,4] <- as.character(round(val14,1))
    tableau$B[15,4] <- as.character(round(val15,1))
    tableau$B[16,4] <- as.character(round(val16,1))
    tableau$B[17,4] <- as.character(round(val17,1))
    tableau$B[18,4] <- as.character(round(val18,1))
    tableau$B[19,4] <- as.character(round(val19,1))
    tableau$B[20,4] <- as.character(round(val20,1))
    tableau$B[21,4] <- as.character(round(val21,1))
    tableau$B[22,4] <- as.character(round(val22,1))
    tableau$B[23,4] <- as.character(round(val23,1))
    tableau$B[24,4] <- as.character(round(val24,1))
    tableau$B[27,4] <- as.character(round(val27num * 100 / val27den,1))
    tableau$B[28,4] <- as.character(round(val28num * 100 / val28den,1))
    tableau$B[29,4] <- as.character(round(val29num * 100 / val29den,1))
    tableau$B[30,4] <- as.character(round(val30num * 100 / val30den,1))
    tableau$B[31,4] <- as.character(round(val31num * 100 / val31den,1))
    tableau$B[32,4] <- as.character(round(val32num * 100 / val32den,1))
    tableau$B[33,4] <- as.character(round(val33num * 100 / val33den,1))
    tableau$B[34,4] <- as.character(round(val34num * 100 / val34den,1))
    tableau$B[35,4] <- as.character(round(val35num * 100 / val35den,1))
    tableau$B[36,4] <- as.character(round(val36num * 100 / val36den,1))
    tableau$B[37,4] <- as.character(round(val37num * 100 / val37den,1))
    tableau$B[38,4] <- as.character(round(val38num / val38den,1))
    tableau$B[43,4] <- as.character(round(val43,1))
    tableau$B[49,4] <- as.character(round(val49,1))
    tableau$B[57,4] <- as.character(round(val57,1))
    tableau$B[58,4] <- as.character(round(val58,1))
    tableau$B[59,4] <- as.character(round(val59 * 100. / valsurf3,1))
    tableau$B[60,4] <- as.character(round(val60 * 100. / valsurf3,1))
    tableau$B[50,4] <- as.character(round(val50num * 100. / val50den,1))
    tableau$B[51,4] <- as.character(round(val51num * 100. / val51den,1))
    tableau$B[52,4] <- as.character(round(val52num * 100. / val52den,1))
    tableau$B[53,4] <- as.character(round(val53num * 100. / val53den,1))
    tableau$B[54,4] <- as.character(round(val54num * 100. / val54den,1))
    tableau$B[55,4] <- as.character(round(val55num * 100. / val55den,1))
    # save ecoval
    name <- paste("SIB no.", input$selectsiteimpact)
    ecoval[[name]] <<- tableau$B
  }else{

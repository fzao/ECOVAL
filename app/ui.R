                                       ...
                                       conditionalPanel(condition = "input.selectsiteimpact != '0'",
                                         tabsetPanel(id="descrimpact",
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="impactindicng", br(),
                                                              ...
                                                              fluidRow(column(6, align="center", actionLink(inputId = "linkCT1", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>'))), column(6, align="center", actionLink(inputId = "linkLT1", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>')))), br(),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Habitat</h4>'), value="impactindicnh", br(),
                                                              ...
                                                              fluidRow(column(6, align="center", actionLink(inputId = "linkCT2", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>'))), column(6, align="center", actionLink(inputId = "linkLT2", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>')))), br(),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Espèce</h4>'), value="impactindicnsp", br(),
                                                              ...
                                                              fluidRow(column(6, align="center", actionLink(inputId = "linkCT3", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>'))), column(6, align="center", actionLink(inputId = "linkLT3", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>')))), br(),
                                      ...
                                      conditionalPanel(condition = "input.selectsitecompens != '0'",
                                                       tabsetPanel(id="descrcompens",
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="compensindicng", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="center", actionLink(inputId = "linkCT4", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>'))), column(6, align="center", actionLink(inputId = "linkLT4", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>')))), br(),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Habitat</h4>'), value="compensindicnh", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="center", actionLink(inputId = "linkCT5", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>'))), column(6, align="center", actionLink(inputId = "linkLT5", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>')))), br(),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Espèce</h4>'), value="compensindicnsp", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="center", actionLink(inputId = "linkCT6", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>'))), column(6, align="center", actionLink(inputId = "linkLT6", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>')))), br(),

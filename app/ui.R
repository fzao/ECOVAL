                                       ...
                                       conditionalPanel(condition = "input.selectsiteimpact != '0'",
                                         tabsetPanel(id="descrimpact",
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Entrée des données</h4>'), value="impactindata", br(),
                                                              fluidRow(column(12, align="center", HTML('<h4 style="color: #A5C226; ">LISTE DES HABITATS - P\u00C9RIM\u00C8TRE SITE</h4>'))), br(),
                                                              ...
                                                              fluidRow(column(3, align="left", selectInput("SItype", label = "Type", choices = list("Fermé" = 1, "Ouvert" = 2, "Buissonnant" = 3, "Zone humide" = 4, "Aquatique" = 5, "Rocheux" = 6, "Cultivé" = 7, "Imperméabilisé" = 8))),
                                                                       column(3, align="left", selectInput("SIetat", label = "Etat conservation", choices = list("-" = 0, "Bon" = 1, "Mauvais" = 2, "Moyen" = 3))),
                                                                       column(3, align="left", selectInput("SIinteret", label = "Intérêt communautaire", choices = list("Non" = 1, "Oui" = 2))),
                                                              ...
                                                              fluidRow(column(2, align="left", textInput("SIlatinnamespecies", "Nom latin")),
                                                                       ...
                                                                       column(2, align="left", selectInput("SItype2", label = "Type 2", choices = list("-"=0, "Cortège généraliste"=1, "Cortège forestier"=2, "Cortège agricole ou ouvert"=3, "Cortège zone humide"=4, "Cortège du bâti"=5, "Odonate"=6,"Lépidoptère"=7,"Orthoptère"=8,"Coléoptère"=9))),
                                                                       column(2, align="left", selectInput("SIprotect", label = "Protection nationale ou régionale", choices = list("Non" = 1, "Oui" = 2))),
                                                                       column(2, align="left", selectInput("SIrougeF", label = "Liste rouge (CR,VU,EN) France", choices = list("Non" = 1, "Oui" = 2)))),
                                                              fluidRow(column(2, align="left", selectInput("SIrougeR", label = "Liste rouge (CR,VU,EN) Régional", choices = list("Non" = 1, "Oui" = 2))),
                                                                       ...
                                                                       column(2, align="left", selectInput("SIexo", label = "Espèce Exotique Envahissante", choices = list("Non" = 1, "Oui" = 2))),
                                                                       column(2, align="left", selectInput("SItvb", label = "TVB", choices = list("Non" = 1, "Oui" = 2))),
                                                                       column(2, align="left", selectInput("SIdet", label = "Déterminant Znieff dans le PE", choices = list("Non" = 1, "Oui" = 2)))),
                                                              ...
                                                              fluidRow(column(12, align="center", HTML('<h4 style="color: #A5C226; ">P\u00C9RIM\u00C8TRE \u00C9LARGI</h4>'))), br(),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="impactindicng", br(),
                                                              ...
                                                              fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkJ1", label=HTML('<h5><b>Justification de l\'estimation</b></h5>'))), textAreaInput("SIjustifCT", NULL, height='125px', placeholder = "justification de l'estimation faite")),
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI1", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SIdegincCT", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                       ...
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible",actionLink(inputId = "linkI2", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SIdegincLT", NULL, c("A", "B", "C"), inline = TRUE)),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Habitat</h4>'), value="impactindicnh", br(),
                                                              ...
                                                              fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkJ3", label=HTML('<h5><b>Justification de l\'estimation</b></h5>'))), textAreaInput("SIjustifCTNH", NULL, height='125px', placeholder = "justification de l'estimation court terme")),
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI3", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SIdegincCTNH", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                       ...
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI4", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SIdegincLTNH", NULL, c("A", "B", "C"), inline = TRUE)),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Espèce</h4>'), value="impactindicnsp", br(),
                                                              ...
                                                              fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkJ5", label=HTML('<h5><b>Justification de l\'estimation</b></h5>'))), textAreaInput("SIjustifCTNSP", NULL, height='125px', placeholder = "justification de l'estimation court terme")),
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI5", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SIdegincCTNSP", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                       ...
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI6", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SIdegincLTNSP", NULL, c("A", "B", "C"), inline = TRUE)),
                                                       ...
                                                       tabsetPanel(id="descrcompens",
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Entrée des données</h4>'), value="compensindata", br(),
                                                                            ...
                                                                            fluidRow(column(3, align="left", selectInput("SCtype", label = "Type", choices = list("Fermé" = 1, "Ouvert" = 2, "Buissonnant" = 3, "Zone humide" = 4, "Aquatique" = 5, "Rocheux" = 6, "Cultivé" = 7, "Imperméabilisé" = 8))),
                                                                                     column(3, align="left", selectInput("SCetat", label = "Etat conservation", choices = list("-" = 0, "Bon" = 1, "Mauvais" = 2, "Moyen" = 3))),
                                                                                     column(3, align="left", selectInput("SCinteret", label = "Intérêt communautaire", choices = list("Non" = 1, "Oui" = 2))),
                                                                            ...
                                                                            fluidRow(column(2, align="left", textInput("SClatinnamespecies", "Nom latin")),
                                                                                     ...
                                                                                     column(2, align="left", selectInput("SCtype2", label = "Type 2", choices = list("-"=0, "Cortège généraliste"=1, "Cortège forestier"=2, "Cortège agricole ou ouvert"=3, "Cortège zone humide"=4, "Cortège du bâti"=5, "Odonate"=6,"Lépidoptère"=7,"Orthoptère"=8,"Coléoptère"=9))),
                                                                                     column(2, align="left", selectInput("SCprotect", label = "Protection nationale ou régionale", choices = list("Non" = 1, "Oui" = 2))),
                                                                                     column(2, align="left", selectInput("SCrougeF", label = "Liste rouge (CR,VU,EN) France", choices = list("Non" = 1, "Oui" = 2)))),
                                                                            fluidRow(column(2, align="left", selectInput("SCrougeR", label = "Liste rouge (CR,VU,EN) Régional", choices = list("Non" = 1, "Oui" = 2))),
                                                                                     ...
                                                                                     column(2, align="left", selectInput("SCexo", label = "Espèce Exotique Envahissante", choices = list("Non" = 1, "Oui" = 2))),
                                                                                     column(2, align="left", selectInput("SCtvb", label = "TVB", choices = list("Non" = 1, "Oui" = 2))),
                                                                                     column(2, align="left", selectInput("SCdet", label = "Déterminant Znieff dans le PE", choices = list("Non" = 1, "Oui" = 2)))),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="compensindicng", br(),
                                                                            ...
                                                                            fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkJC1", label=HTML('<h5><b>Justification de l\'estimation</b></h5>'))), textAreaInput("SCjustifCT", NULL, height='125px', placeholder = "justification de l'estimation faite")),
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC1", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SCdegincCT", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                                     ...
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC2", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SCdegincLT", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Habitat</h4>'), value="compensindicnh", br(),
                                                                            ...
                                                                            fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkJC3", label=HTML('<h5><b>Justification de l\'estimation</b></h5>'))), textAreaInput("SCjustifCTNH", NULL, height='125px', placeholder = "justification de l'estimation court terme")),
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC3", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SCdegincCTNH", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                                     ...
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC4", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SCdegincLTNH", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Espèce</h4>'), value="compensindicnsp", br(),
                                                                            ...
                                                                            fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkJC5", label=HTML('<h5><b>Justification de l\'estimation</b></h5>'))), textAreaInput("SCjustifCTNSP", NULL, height='125px', placeholder = "justification de l'estimation court terme")),
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC5", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SCdegincCTNSP", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                                     ...
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC6", label=HTML('<h5><b>Niveau d\'incertitudes</b></h5>'))), checkboxGroupInput("SCdegincLTNSP", NULL, c("A", "B", "C"), inline = TRUE)),

                                       ...
                                       conditionalPanel(condition = "input.selectsiteimpact != '0'",
                                         tabsetPanel(id="descrimpact",
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Entrée des données</h4>'), value="impactindata", br(),
                                                              fluidRow(column(12, align="center", HTML('<h4 style="color: #A5C226; ">LISTE DES HABITATS - P\u00C9RIM\u00C8TRE SITE (PS)</h4>'))), br(),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="impactindicng", br(),
                                                              ...
                                                              fluidRow(column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkCT1", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')))), column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkLT1", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))))), br(),
                                                              fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SI_NG.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SIjustifCT", NULL, height='125px', placeholder = "justification de l'estimation faite")),
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI1", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SIdegincCT", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                       column(2, align="left", numericInput("SIvalCT", "Valeur après impact", value = 0.)),
                                                                       column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SI_NG.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SIjustifLT", NULL, height='125px', placeholder = "justification de l'estimation faite")),
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible",actionLink(inputId = "linkI2", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SIdegincLT", NULL, c("A", "B", "C"), inline = TRUE)),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Habitat</h4>'), value="impactindicnh", br(),
                                                              ...
                                                              fluidRow(column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkCT2", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')))), column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkLT2", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))))), br(),
                                                              fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SI_NH.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SIjustifCTNH", NULL, height='125px', placeholder = "justification de l'estimation court terme")),
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI3", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SIdegincCTNH", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                       column(2, align="left", numericInput("SIvalCTNH", "Valeur après impact CT", value = 0.)),
                                                                       column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation</b></h5>')), HTML('<a href="Aide_estimation_SI_NH.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SIjustifLTNH", NULL, height='125px', placeholder = "justification de l'estimation long terme")),
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI4", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SIdegincLTNH", NULL, c("A", "B", "C"), inline = TRUE)),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Espèce</h4>'), value="impactindicnsp", br(),
                                                              ...
                                                              fluidRow(column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkCT3", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')))), column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkLT3", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))))), br(),
                                                              fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SI_NSp.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SIjustifCTNSP", NULL, height='125px', placeholder = "justification de l'estimation court terme")),
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI5", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SIdegincCTNSP", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                       column(2, align="left", numericInput("SIvalCTNSP", "Valeur après impact CT", value = 0.)),
                                                                       column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation</b></h5>')), HTML('<a href="Aide_estimation_SI_NSp.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SIjustifLTNSP", NULL, height='125px', placeholder = "justification de l'estimation long terme")),
                                                                       column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkI6", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SIdegincLTNSP", NULL, c("A", "B", "C"), inline = TRUE)),
                                      ...
                                      conditionalPanel(condition = "input.selectsitecompens != '0'",
                                                       tabsetPanel(id="descrcompens",
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="compensindicng", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkCT4", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')))), column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkLT4", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))))), br(),
                                                                            fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SC_NG.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SCjustifCT", NULL, height='125px', placeholder = "justification de l'estimation faite")),
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC1", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SCdegincCT", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                                     column(2, align="left", numericInput("SCvalCT", "Valeur après compensation", value = 0.)),
                                                                                     column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SC_NG.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SCjustifLT", NULL, height='125px', placeholder = "justification de l'estimation faite")),
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC2", label=HTML('<h5><b>Source d\'incertitudes</b></h5>'))), checkboxGroupInput("SCdegincLT", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Habitat</h4>'), value="compensindicnh", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkCT5", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')))), column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkLT5", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))))), br(),
                                                                            fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SC_NH.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SCjustifCTNH", NULL, height='125px', placeholder = "justification de l'estimation court terme")),
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC3", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SCdegincCTNH", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                                     column(2, align="left", numericInput("SCvalCTNH", "Valeur après compensation CT", value = 0.)),
                                                                                     column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SC_NH.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SCjustifLTNH", NULL, height='125px', placeholder = "justification de l'estimation long terme")),
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC4", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SCdegincLTNH", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Espèce</h4>'), value="compensindicnsp", br(),
                                                                            ...
                                                                            fluidRow(column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkCT6", label=HTML('<h4 style="color: #A5C226; ">COURT TERME</h4>')))), column(6, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkLT6", label=HTML('<h4 style="color: #A5C226; ">LONG TERME</h4>'))))), br(),
                                                                            fluidRow(column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SC_NSp.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SCjustifCTNSP", NULL, height='125px', placeholder = "justification de l'estimation court terme")),
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC5", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SCdegincCTNSP", NULL, c("A", "B", "C"), inline = TRUE)),
                                                                                     column(2, align="left", numericInput("SCvalCTNSP", "Valeur après compensation CT", value = 0.)),
                                                                                     column(2, align="left", tags$div(style="display:inline-block",title="Aide disponible", HTML('<h5><b>Justification de l\'estimation   </b></h5>')), HTML('<a href="Aide_estimation_SC_NSp.pdf" target="_blank"><img src="aide.png" alt="justification"></a>'), textAreaInput("SCjustifLTNSP", NULL, height='125px', placeholder = "justification de l'estimation long terme")),
                                                                                     column(2, align="center", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "linkC6", label=HTML('<h5><b>Source d\'incertitude</b></h5>'))), checkboxGroupInput("SCdegincLTNSP", NULL, c("A", "B", "C"), inline = TRUE)),

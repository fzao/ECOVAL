...
shinyUI(fluidPage(HTML("<!DOCTYPE html>
                  ...
                  tabsetPanel(id="tabs",
                              ...
                              tabPanel(value="accueil", HTML('<h4 style="color: #005BBB; "><b>Accueil</b></h4>'), br(),
                                       ...
                                       HTML('<a href="Projet_Exemple.xlsx" target="_blank"><img src="Excel_logo.gif" alt="Fichier projet ECOVAL"></a>'),
                                       includeMarkdown("md/accueil_2.md"), br(),
                                       fluidRow(column(6, align="center", HTML('<h4 style="color: #005BBB; "><b>1 - La méthode ECOVAL</b></h4>'), HTML('<iframe width="560" height="315" src="https://www.youtube.com/embed/U_Rzj3fUX0k" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')),
                                                column(6, align="center", HTML('<h4 style="color: #005BBB; "><b>2 - L\'interface ECOVAL</b></h4>'), HTML('<iframe width="560" height="315" src="https://www.youtube.com/embed/yFMJrBLWPpc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'))), br(), br(),
                                       fluidRow(column(6, align="center", HTML('<h4 style="color: #005BBB; "><b>3 - Créer un projet</b></h4>'), HTML('<iframe width="560" height="315" src="https://www.youtube.com/embed/hf3CAaKvE-w" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')),
                                                column(6, align="center", HTML('<h4 style="color: #005BBB; "><b>4 - Saisie des données à l\'état initial</b></h4>'), HTML('<iframe width="560" height="315" src="https://www.youtube.com/embed/p2Lfp2fl5fY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'))), br(), br(),
                                       fluidRow(column(6, align="center", HTML('<h4 style="color: #005BBB; "><b>5 - Estimations après impact et compensation</b></h4>'), HTML('<iframe width="560" height="315" src="https://www.youtube.com/embed/HiqxpnstO-k" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')),
                                                column(6, align="center", HTML('<h4 style="color: #005BBB; "><b>6 - Les résultats : graphes, tableaux et rapport de synthèse</b></h4>'), HTML('<iframe width="560" height="315" src="https://www.youtube.com/embed/7S-nxEtDid0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')))),
                              # PROJET ----------------------------------------------------
                                         ...
                                         mainPanel(
                                           tabsetPanel(id="prjtabs",
                                             tabPanel(HTML('<h4 style="color: #005BBB; ">Description du site</h4>'), value="description", br(),
                                                      ...
                                                      fluidRow(column(8, align="left", textAreaInput("sitecontext", "CONTEXTE", height='170px', width='800px', placeholder = "Décrire le contexte du site ici...")), column(4, align="left", numericInput("perimelargi", tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "perimdescr", label=HTML('<h5><b>Périmètre élargi (km)</b></h5>'))), value = 0., min = 0., max = 1e6, step = 1.))),
                                                      ...
                                                      fluidPage(
                                                        column(6, align="center",
                                                               ...
                                                               fluidRow(column(3, align="left", textInput("namehabitat", "Nom")),
                                                                        ...
                                                                        column(3, align="left", selectInput("typehabitat", label = "Type", choices = list("Forestier" = 1, "Ouvert" = 2, "Buissonnant" = 3, "Zone humide" = 4, "Aquatique" = 5, "Rocheux" = 6, "Cultivé" = 7, "Imperméabilisé" = 8)))), br(),
                                                        ...
                                                        column(6, align="center",
                                                               ...
                                                               fluidRow(column(3, align="left", textInput("latinnamespecies", "Nom Latin")),
                                                                        column(3, align="left", textInput("frenchnamespecies", "Nom Français")),
                                                                        column(3, align="left", selectInput("typespecies", label = "Type", choices = list("Avifaune" = 1, "Chiroptère" = 2, "Mammifère" = 3, "Amphibien" = 4, "Reptile" = 5, "Insecte" = 6, "Flore" = 7, "Poisson" = 8, "Crustacé/Mollusque" = 9))),
                                                                        column(3, align="left", selectInput("commfaun", label = tags$div(style="display:inline-block",title="Aide disponible", actionLink(inputId = "regrpsp", label=HTML('<h5><b>Regroupement d\'espèces</b></h5>'))), choices = list("Non" = 1, "Oui" = 2)))), br(),
                                                     ...
                                                     tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="impactindicng", br(),
                                                          tabsetPanel(id="descrNGSI",
                                                              tabPanel(HTML('<h4 style="color: #005BBB; ">Saisie des données brutes</h4>'), value="impactrawdata", br(),
                                                                       ...
                                                                       fluidRow(column(3, align="left", selectInput("SItype", label = "(\u03A3) Type", choices = list("Forestier" = 1, "Ouvert" = 2, "Buissonnant" = 3, "Zone humide" = 4, "Aquatique" = 5, "Rocheux" = 6, "Cultivé" = 7, "Imperméabilisé" = 8))),
                                                                                ...
                                                                                column(3, align="left", selectInput("SImenace", label = "(\u03A3) En danger ou menacé localement", choices = list("Non" = 1, "Oui" = 2, "-" = 3)))), br(),
                                                                       ...
                                                                       fluidRow(column(2, align="left", textInput("SIlatinnamespecies", "(\u03A3) Nom latin")),
                                                                                ...
                                                                                column(2, align="left", selectInput("SItype1", label = "(\u03A3) Type 1", choices = list("Avifaune" = 1, "Mammifère" = 3, "Amphibien" = 4, "Reptile" = 5, "Insecte" = 6, "Flore" = 7, "Poisson" = 8, "Crustacé/Mollusque" = 9))),
                                                                                column(2, align="left", selectInput("SItype2", label = "(\u03A3) Type 2", choices = list("-"=0, "Cortège généraliste"=1, "Cortège forestier"=2, "Cortège agricole ou ouvert"=3, "Cortège zone humide"=4, "Cortège du bâti"=5, "Odonate"=6,"Lépidoptère"=7,"Orthoptère"=8,"Coléoptère"=9,"Chiroptère"=10,"Autre"=11))),
                                                                       ...
                                                                       fluidRow(column(2, align="left", selectInput("SIrougeR", label = "(\u03A3) Liste rouge (CR,VU,EN) Régional", choices = list("Non" = 1, "Oui" = 2))),
                                                                                column(2, align="left", selectInput("SIdirect", label = "(\u03A3) Directives Européennes", choices = list("Non" = 0, "Annexe II DFFH" = 1, "Annexe I DO" = 2))),
                                                                                column(2, align="left", selectInput("SIreprod", label = "(\u03A3) Reproduction", choices = list("Non" = 0, "Certaine" = 1, "Possible" = 2, "-" = 3))),
                                                                       ...
                                                                       fluidRow(column(3, align="left", selectInput("SIpertype", label = "(\u03A3) Type", choices = list("Forestier" = 1, "Ouvert" = 2, "Buissonnant" = 3, "Zone Humide" = 4, "Aquatique" = 5, "Rocheux" = 6, "Cultivé" = 7, "Imperméabilisé" = 8))),
                                                                   ...
                                                                   tabPanel(HTML('<h4 style="color: #005BBB; ">Niveau Général</h4>'), value="compensindicng", br(),
                                                                        tabsetPanel(id="descrNGSC",
                                                                            tabPanel(HTML('<h4 style="color: #005BBB; ">Saisie des données brutes</h4>'), value="compensrawdata", br(),
                                                                                     ...
                                                                                     fluidRow(column(3, align="left", selectInput("SCtype", label = "(\u03A3) Type", choices = list("Forestier" = 1, "Ouvert" = 2, "Buissonnant" = 3, "Zone humide" = 4, "Aquatique" = 5, "Rocheux" = 6, "Cultivé" = 7, "Imperméabilisé" = 8))),
                                                                                              ...
                                                                                              column(3, align="left", selectInput("SCmenace", label = "(\u03A3) En danger ou menacé localement", choices = list( "Non" = 1, "Oui" = 2, "-" = 3)))), br(),
                                                                                     ...
                                                                                     fluidRow(column(2, align="left", textInput("SClatinnamespecies", "(\u03A3) Nom latin")),
                                                                                              ...
                                                                                              column(2, align="left", selectInput("SCtype1", label = "(\u03A3) Type 1", choices = list("Avifaune" = 1, "Mammifère" = 3, "Amphibien" = 4, "Reptile" = 5, "Insecte" = 6, "Flore" = 7, "Poisson" = 8, "Crustacé/Mollusque" = 9))),
                                                                                              column(2, align="left", selectInput("SCtype2", label = "(\u03A3) Type 2", choices = list("-"=0, "Cortège généraliste"=1, "Cortège forestier"=2, "Cortège agricole ou ouvert"=3, "Cortège zone humide"=4, "Cortège du bâti"=5, "Odonate"=6,"Lépidoptère"=7,"Orthoptère"=8,"Coléoptère"=9,"Chiroptère"=10,"Autre"=11))),
                                                                                     ...
                                                                                     fluidRow(column(2, align="left", selectInput("SCrougeR", label = "(\u03A3) Liste rouge (CR,VU,EN) Régional", choices = list("Non" = 1, "Oui" = 2))),
                                                                                              column(2, align="left", selectInput("SCdirect", label = "(\u03A3) Directives Européennes", choices = list("Non" = 0, "Annexe II DFFH" = 1, "Annexe I DO" = 2))),
                                                                                              column(2, align="left", selectInput("SCreprod", label = "(\u03A3) Reproduction", choices = list("Non" = 0, "Certaine" = 1, "Possible" = 2, "-" = 3))),
                                                                                     ...
                                                                                     fluidRow(column(12, align="center", HTML('<h4 style="color: #A5C226; ">P\u00C9RIM\u00C8TRE \u00C9LARGI (PE)</h4>'))), br(),
                                                                                     fluidRow(column(3, align="left", selectInput("SCpertype", label = "(\u03A3) Type", choices = list("Forestier" = 1, "Ouvert" = 2, "Buissonnant" = 3, "Zone Humide" = 4, "Aquatique" = 5, "Rocheux" = 6, "Cultivé" = 7, "Imperméabilisé" = 8))),

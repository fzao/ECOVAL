...
shinyUI(fluidPage(HTML("<!DOCTYPE html>
                  ...
                  tabsetPanel(id="tabs",
                              ...
                              tabPanel(value="accueil", HTML('<h4 style="color: #005BBB; "><b>Accueil</b></h4>'), br(),
                                       ...
                                       fluidRow(column(4, align="center", HTML('<h4 style="color: #005BBB; "><b>1 - La métohde ECOVAL</b></h4>'), HTML('<iframe width="420" height="236" src="https://www.youtube.com/embed/cMszCEuZzHg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')),
                                                column(4, align="center", HTML('<h4 style="color: #005BBB; "><b>2 - L\'interface ECOVAL</b></h4>'), HTML('<iframe width="420" height="236" src="https:/www.youtube.com/embed/0jpDHJECiyk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')),
                                                column(4, align="center", HTML('<h4 style="color: #005BBB; "><b>3 - Créer un projet</b></h4>'), HTML('<iframe width="420" height="236" src="https://www.youtube.com/embed/9-HQ-99j6Is" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'))), br(), br(),
                                       fluidRow(column(4, align="center", HTML('<h4 style="color: #005BBB; "><b>4 - Saisie des données à l\'état initial</b></h4>'), HTML('<iframe width="420" height="236" src="https://www.youtube.com/embed/wWoaL_9VkFc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')),
                                                column(4, align="center", HTML('<h4 style="color: #005BBB; "><b>5 - Estimations après impact et compensation</b></h4>'), HTML('<iframe width="420" height="236" src="https://www.youtube.com/embed/WMrTsA3x3uo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')),
                                                column(4, align="center", HTML('<h4 style="color: #005BBB; "><b>6 - Les résultats : graphes, tableaux et rapport de synthèse</b></h4>'), HTML('<iframe width="420" height="236" src="https:/www.youtube.com/embed/bfbqFxKYKhQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>')))),
                              # PROJET ----------------------------------------------------
